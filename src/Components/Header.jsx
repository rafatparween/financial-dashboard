...
//         <div className="relative my-auto text-[28px] text-[#343C6A] font-inter">Overview</div>
//       </div>
...
// const Header = () => {
//   return (
//     <header className="w-full flex flex-col sm:flex-row items-center justify-between px-4 py-4 bg-white">
